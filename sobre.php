...
<?php include 'header1.php' ?>
    ...
    <section class="container mx-auto about">
        <div class="row">
            <div class="col-md-6 bloco-img">
                <img src="./img/sobre-block.png" alt="Imagem de sobre a GR2B" class="img-fluid img-thumbnail">

                <blockquote class="blockquote">
                    <img class="aspas-top" src="./img/aspas.svg" alt="">
                    <p>"Viemos para proporcionar tecnologia inovadora que transforme as empresas, apliando suas vendas e
                        reduzindo seus custos."</p>
                    <img class="aspas-bottom" src="./img/aspas.svg" alt="">
                </blockquote>
