...
<head>
    ...
    <section class="container mx-auto py-5">
        <div class="row">
            <div class="col-md-6" style="text-align: center;">
                ...
                <form method="POST" enctype="multipart/form-data" action="enviar-vaga.php">
                    ...
                    <input class="form-control mb-2" type="file" name="arquivo" id="arquivo" accept=".pdf,.docx" required="" value="30000">
    ...
    <script>
        $('form').submit(function() {
            ...
            setTimeout(function() {
                location.reload('/trabalhe-conosco.php');
            }, 2000);
        });
    </script>
    </body>
