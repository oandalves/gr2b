<footer>
    <div class="footer ">
        ...
        <div class="footer-bloco ">
            <h2>Produtos</h2>
            <p><a href="plataforma-ecommerce-b2b.php">Plataforma B2B</a></p>
            <p><a href="recursos.php">Recursos</a></p>
            <p><a href="planos.php">Planos</a></p>
        </div>
        <div class="footer-bloco last ">
            <a href="contato.php " class="fale-especialista ">Fale com um especialista</a>
